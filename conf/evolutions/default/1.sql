...
create table "usercertificate" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,
"userID" VARCHAR NOT NULL, "certificateNumber" VARCHAR NOT NULL, "validFrom" DATE NOT NULL,
"validity_in_milliseconds" BIGINT NOT NULL);
